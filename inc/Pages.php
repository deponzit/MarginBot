			...
			<div class="panel panel-default">
				...
				<div class="panel-body table-responsive">
					<table class="table table-striped table-bordered">
						...
						<th></th>
						<th class="mid" colspan="2">
                            <div style="height: 20px;padding-top:2px;" aria-label="Help" class="pull-right"  data-toggle="popover" data-placement="right" title="Currency" data-content="Select which currency to manage with this bot.">
                              <span class="glyphicon glyphicon-question-sign" aria-hidden="true"></span>
                            </div>
                            Currency
                        </th>
						...
						<tr>
						    <td></td>
						    <td class="mid" colspan="2">
								<select  id="inputCurrency" class="form-control" autofocus="" name="new_currency">
            ...
            if(count($accounts) > 1 || (count($accounts) == 1 && $Count == 0)){
                ...
                echo "
					<script>
						...
						var userCurrencies = ['".implode("','", $userCurrencies)."'];
					</script>
        ...
        // Individual Stats //
            ...
            echo "
                ...
                <script>
					...
					var userCurrencies = ['".$_SESSION['currency']."'];
                </script>
				<script type='text/javascript' src='js/user_chart.js'></script>
